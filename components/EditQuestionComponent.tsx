...
<form onSubmit = {async (e) => {
  ...
  <input value = {valueMin} type="number" onChange = {(e)=>{setValueMin(e.currentTarget.valueAsNumber)}}/>
  <input value = {descriptionMin} onChange = {(e)=>{setDescriptionMin(e.currentTarget.value)}}/>
  <input value = {valueMax} type="number" onChange = {(e)=>{setValueMax(e.currentTarget.valueAsNumber)}}/>
  <input value = {descriptionMax} onChange = {(e)=>{setDescriptionMax(e.currentTarget.value)}}/>
